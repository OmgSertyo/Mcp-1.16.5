...
public class IngameGui extends AbstractGui
{
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks)
    {
        ...
        EventManager.call(new EventRender2D(matrixStack, mc.getMainWindow(), partialTicks));
    ...
    {
        EventOverlay overlaysRender = new EventOverlay(EventOverlay.OverlayType.SCOREBOARD);
