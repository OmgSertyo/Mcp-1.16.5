...
@UtilityClass
public class StencilUtility implements Util {
    ...
    private void recreate(final Framebuffer framebuffer) {
        ...
        GL30.glRenderbufferStorage(GL30.GL_RENDERBUFFER, GL30.GL_DEPTH_STENCIL, mc.getMainWindow().getFramebufferWidth(), mc.getMainWindow().getFramebufferHeight());
